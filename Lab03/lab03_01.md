...
1. https://servicetrust.microsoft.com/DocumentPage/7adf2d9e-d7b5-4e71-bad8-713e6a183cf3에서 Azure - 규정 준수 제공 문서( Azure - Compliance Offerings)를 다운로드합니다.
...
5. 테이블의 특정 속성에 대한 질문에 대한 이해를 높이기 위해 동의어에서 편집을 선택합니다.
   ...
   Address 1의 경우 동의어로 </br>
   Address를 추가하고 설명으로</br>
   Complete address of the account</br>
   를 추가합니다.
